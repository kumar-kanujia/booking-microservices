...
public class ScheduleCrudServiceImpl implements ScheduleCrudService {
	...
	public void addSchedule(Schedule schedule) {
		...
		schedule.getSlot1().setId(bookingClient.createSlot(parkingSlot1).getId());
		schedule.getSlot2().setId(bookingClient.createSlot(parkingSlot2).getId());
		schedule.getSlot2().setId(bookingClient.createSlot(parkingSlot3).getId());
